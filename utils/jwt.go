...
// @title: create jwt instance
// @param: privateKey: private key, publicKey: public key
// @return: jwt: jwt instance
...
// @param: ttl: time to live, content: custom data
// @return: token: jwt token, error: error
...
// @return: claims: jwt claims, error: error
